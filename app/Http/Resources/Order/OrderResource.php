...
class OrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'tax' => [
                'mode' => $this->tax_mode ?? 'none',
                'name' => $this->tax_name,
                'rate' => $this->tax_rate !== null ? (float) $this->tax_rate : null,
                'taxable_amount' => $this->taxable_amount !== null ? $this->roundMoney($this->taxable_amount) : null,
                'amount' => $this->roundMoney($this->tax_amount ?? 0),
                'product_tax_amount' => $this->roundMoney($this->product_tax_amount ?? 0),
                'inherited' => ($this->tax_mode ?? '') === 'global_default',
            ],
