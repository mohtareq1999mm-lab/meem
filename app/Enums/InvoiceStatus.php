...
enum InvoiceStatus: string
{
    ...
    public function allowedTransitions(): array
    {
        return match ($this) {
            ...
            self::GENERATED => [self::PDF_GENERATING, self::VERIFIED, self::DOWNLOADED, self::PRINTED, self::CORRECTED, self::CANCELLED],
            ...
            self::VERIFIED => [self::DOWNLOADED, self::PRINTED, self::ARCHIVED],
            self::DOWNLOADED => [self::PRINTED, self::VERIFIED, self::ARCHIVED],
            self::PRINTED => [self::DOWNLOADED, self::VERIFIED, self::ARCHIVED],
